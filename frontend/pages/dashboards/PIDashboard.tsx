    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-4">
      {ACTION_CARDS.map(c => (
        <Link
          key={c.path}
          to={c.path}
          className="flex items-start gap-3 rounded-xl border border-border-primary bg-bg-card p-3 hover:border-cyan-500/30 hover:bg-hover-bg transition-all group min-w-0"
        >
          <div
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs font-medium text-text-primary group-hover:text-cyan-400 transition-colors whitespace-normal break-words">
              {c.label}
            </p>
