      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            autoFocus
            className="w-full h-11 px-3 rounded-lg appearance-none bg-ksp-navy-mid border border-ksp-navy-light text-ksp-white outline-none placeholder:text-ksp-muted/60 focus:border-ksp-amber focus:shadow-[0_0_0_1px_rgba(245,158,11,0.3)] transition-colors duration-150"
          />
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full h-11 px-3 pr-10 rounded-lg appearance-none bg-ksp-navy-mid border border-ksp-navy-light text-ksp-white outline-none placeholder:text-ksp-muted/60 focus:border-ksp-amber focus:shadow-[0_0_0_1px_rgba(245,158,11,0.3)] transition-colors duration-150"
            />
            <button
              type="button"
              onClick={() => setShowPw((s) => !s)}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-ksp-muted hover:text-ksp-white"
        ...
        <button
          ...
          className="w-full h-12 rounded-xl bg-ksp-amber text-ksp-navy font-semibold text-sm transition-all duration-200 hover:brightness-110 active:scale-[0.99] disabled:opacity-70 disabled:cursor-wait flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="w-full text-center text-[11px] text-ksp-muted/70 hover:text-ksp-white underline-offset-2 hover:underline transition-colors duration-150"
        >
