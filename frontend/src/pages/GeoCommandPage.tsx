...
export function GeoCommandPage() {
  ...
  const [rightPanelTab, setRightPanelTab] = useState<'dashboard' | 'hotspots'>('dashboard');
  ...
  return (
    <div className="relative w-full h-full min-h-[calc(100vh-8rem)] overflow-hidden bg-bg-dark">
        ...
        <div className="pointer-events-auto flex flex-col gap-3 items-end max-h-[calc(100vh-6rem)] overflow-y-auto">
          ...
          {!selectedOpsHotspot && (
            <div className="hidden md:flex gap-1 glass rounded-lg px-2 py-1.5 shadow">
              <button
                onClick={() => { setRightPanelTab('dashboard'); setTimeout(triggerResize, 100); }}
                className={`text-[11px] px-2 sm:px-3 py-1 rounded-md transition-colors ${
              ...
              <button
                onClick={() => { setRightPanelTab('hotspots'); setTimeout(triggerResize, 100); }}
                className={`text-[11px] px-2 sm:px-3 py-1 rounded-md transition-colors ${
            ...
            <div className="p-4">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-text-primary">
                  {selectedOpsHotspot ? 'Details' : rightPanelTab === 'dashboard' ? 'Dashboard' : 'Hotspots'}
                </h2>
      ...
      {/* Map legend (bottom-right) - z-40, with proper scroll */}
      <div className="absolute right-2 sm:right-3 bottom-24 sm:bottom-28 z-40 pointer-events-none max-h-[calc(100vh-8rem)]">
        <div className="pointer-events-auto">
