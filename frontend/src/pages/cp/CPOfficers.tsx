...
export function CPOfficers() {
  ...
  return (
    <div className="flex flex-col h-auto lg:h-[calc(100vh-4rem)] overflow-visible lg:overflow-hidden">
      {/* Header */}
      ...
      {/* KPI Summary */}
      {summary && (
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 px-4 py-2 border-b border-white/10 bg-slate-900/50 flex-shrink-0">
          {[
      ...
      <div className="flex flex-1 overflow-hidden flex-col lg:flex-row">
        ...
        {/* Sidebar */}
        <div className="w-full lg:w-80 border-t lg:border-t-0 lg:border-l border-white/10 bg-slate-900/80 backdrop-blur-sm overflow-visible lg:overflow-y-auto flex-shrink-0">
