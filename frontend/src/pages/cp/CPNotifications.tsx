  ...
  const fetchData = useCallback(async () => {
    const getDemoData = () => {
      ...
      const notifications: NotificationItem[] = [
          ...
          { id: 'notif-004', title: 'System Update: Analytics Dashboard v2.1', message: 'Analytics dashboard v2.1 deployed with improved area-level incident trend visualizations.', category: 'system', read: true, critical: false, timestamp: new Date(now.getTime() - 14400000).toISOString(), source: 'IT Department', actionable: false },
